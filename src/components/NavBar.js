    ...
    <nav class="flex justify-between bg-gray-900 text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          <li><Link to="/" class="hover:text-gray-200" href="#">Home</Link ></li>
          <li><Link to="/about" class="hover:text-gray-200" href="#">about</Link ></li>
          <li><Link to="/contact"  class="hover:text-gray-200" href="#">Contact Us</Link ></li>
          <li><Link  to="/product" class="hover:text-gray-200" href="#">Products</Link ></li>
          <li><Link to="/store"  class="hover:text-gray-200" href="#">Store</Link ></li>
          <li><Link to="/story" class="hover:text-gray-200" href="#">Story</Link ></li>
        </ul>
        {/* <!-- Header Icons --> */}
